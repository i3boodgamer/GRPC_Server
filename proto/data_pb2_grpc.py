...
class DataServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendPacket = channel.unary_unary(
                '/DataService/SendPacket',
                request_serializer=data__pb2.Packet.SerializeToString,
...
def add_DataServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendPacket': grpc.unary_unary_rpc_method_handler(
                    servicer.SendPacket,
                    request_deserializer=data__pb2.Packet.FromString,
...
class DataService(object):
    ...
    def SendPacket(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/DataService/SendPacket',
            data__pb2.Packet.SerializeToString,
